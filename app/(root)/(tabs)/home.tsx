        ...
        ListHeaderComponent={() => (
          <>
            <View className="flex flex-row items-center justify-between my-5">
              <Text className="text-white text-2xl font-JakartaExtraBold capitalize">
            ...
            <>
              <Text className="text-xl text-white font-JakartaMedium mt-5 mb-3">
